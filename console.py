...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, arg):
        """Print the string representation of all instances or
        a specific class.
        Usage: <User>.all()
        <user>.show()
        """
                ...
                if curly_braces:
                    try:
                        ...
                        try:
                            ...
                            setattr(obj, att_name2, attr_value2)
                        except Exception:
                            pass
                    except Exception:
                        pass
                    ...
                    try:
                        attr_value = eval(attr_name, attr_value)
                    except Exception:
                        pass
    ...
    def default(self, arg):
        ...
        if cmd_met in method_dict.keys():
            if cmd_met != "update":
                return method_dict[cmd_met]("{} {}".format(class_name, e_arg))
            else:
                if not class_name:
                    print("** class name missing **")
                    return
